...
- [x] **Gráficos**: Gráficos de dois vetores, no formato “candlestick”. Isso facilitará, por exemplo, a diminuição das emissões de CO², ou a economia de combustível, ou mesmo a quantitativo de lixo produzido,  com e sem o uso da Taggy.
- [x] **Compilador de Resultados**: Possibilita exportar os diversos dados e variáveis relacionadas de forma padronizada e editável.
...
<img width="1197" height="977" alt="image" src="https://github.com/user-attachments/assets/06d067b2-c8de-4a45-bc7f-4e2e3a1b6075" />

# Diagrama sequencial:

<img width="1197" height="977" alt="image" src="https://github.com/user-attachments/assets/7ff12a1e-4e5f-4781-96cd-a8bbfb33f1da" />
